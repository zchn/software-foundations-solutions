...
Theorem rev_snoc_cons_rev : forall l : natlist, forall n : nat,
...
Theorem rev_injective : forall l1 : natlist, forall l2 : natlist,
  rev l1 = rev l2 -> l1 = l2.
Proof.
  intros.                            
  rewrite <- rev_involutive.
  assert (l1 = rev (rev l1)).
  rewrite rev_involutive.
  reflexivity.
  rewrite H0.
  rewrite H.
